...
import {
  ...
  DialogTitle,
  DialogFooter,
} from "@workspace/shared-ui/components/dialog";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Minha Agenda</h2>
          <p className="text-muted-foreground text-sm mt-1">
            Gerencie seus horários disponíveis para atendimento
          </p>
        </div>
        <Button onClick={() => openNewSlot()} className="gap-2 self-start">
            ...
            {!selectedDate ? (
              ...
              <div className="text-center py-8 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Nenhuma disponibilidade adicionada para este dia.
                </p>

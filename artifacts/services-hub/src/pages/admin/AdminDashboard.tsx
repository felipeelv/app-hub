      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-card rounded-2xl border border-border/60 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-border/60 flex justify-between items-center">
            <h2 className="text-lg font-display font-bold">Ordens de Serviço Recentes</h2>
        ...
        <div className="bg-card rounded-2xl border border-border/60 shadow-sm p-6 flex flex-col">
          <h2 className="text-lg font-display font-bold mb-6">Resumo Operacional</h2>

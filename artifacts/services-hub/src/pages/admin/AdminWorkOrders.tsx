...
export function AdminWorkOrders() {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-card rounded-2xl border border-border/60 shadow-sm overflow-hidden flex flex-col min-h-[600px]">
        <div className="p-6 border-b border-border/60 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-muted/10">
          <h2 className="text-xl font-display font-bold">Ordens de Serviço</h2>
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-border/50">
              {isLoading ? (
                ...
                filtered?.map(wo => (
                  <tr key={wo.id} className="hover:bg-muted/30 transition-colors group cursor-pointer" onClick={() => navigate(`/admin/work-orders/${wo.id}`)}>
